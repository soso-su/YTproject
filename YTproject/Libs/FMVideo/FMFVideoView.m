...
- (void)BuildUIWithType:(FMVideoViewType)type
{
    ...
    self.topView.frame = CGRectMake(0, 10, kScreen_Height, 44);
    [self addSubview:self.topView];
    
    self.timeView = [[UIView alloc] init];
    self.timeView.hidden = YES;
    self.timeView.frame = CGRectMake((kScreen_Width - 100)/2, 16, 100, 34);
    ...
    self.turnCamera.frame = CGRectMake(kScreen_Width - 60 - 28, 11, 28, 22);
    ...
    self.flashBtn.frame = CGRectMake(kScreen_Width - 22 - 15, 11, 22, 22);
    ...
    self.progressView = [[FMRecordProgressView alloc] initWithFrame:CGRectMake((kScreen_Width - 62)/2, kScreen_Height - 32 - 62, 62, 62)];
